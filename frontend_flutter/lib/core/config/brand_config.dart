/// Identidad de marca Farma Express.
class BrandConfig {
  static const String appName = 'Farma Express';
  static const String shortName = 'FarmaExpress';
  static const String tagline = 'Todo lo que buscas en un solo lugar';
