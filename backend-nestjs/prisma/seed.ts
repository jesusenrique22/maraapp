...
async function main() {
  ...
  const branches = [
    {
      name: 'MaraPlus Bella Vista',
      slug: 'bella-vista',
      address: 'Av. Bella Vista con Calle 72, sector Bella Vista',
      city: 'Maracaibo',
      state: 'Zulia',
    ...
    {
      name: 'MaraPlus 5 de Julio',
      slug: '5-de-julio',
      address: 'Calle 77 (5 de Julio) con Av. 15 (Delicias)',
      city: 'Maracaibo',
      state: 'Zulia',
      phone: '+58 261-555-0102',
      whatsapp: '+58 414-555-0102',
      openingHours: 'Lun–Sáb 7:00–22:00 · Dom 8:00–20:00',
      isMain: false,
      sortOrder: 2,
      latitude: 10.6625,
      longitude: -71.6152,
    ...
    {
      name: 'MaraPlus Delicias La Rubio',
      slug: 'delicias-la-rubio',
      address: 'Av. 15 (Delicias) con Prolongación Circunvalación 2, sector La Rubio',
      city: 'Maracaibo',
      state: 'Zulia',
      phone: '+58 261-555-0103',
      whatsapp: '+58 414-555-0103',
      openingHours: 'Lun–Sáb 7:00–21:00 · Dom 8:00–18:00',
      isMain: false,
      sortOrder: 3,
      latitude: 10.6812,
      longitude: -71.6198,
    ...
    {
      name: 'MaraPlus La Limpia',
      slug: 'la-limpia',
      address: 'Av. La Limpia, frente a Galerías Mall',
      city: 'Maracaibo',
      state: 'Zulia',
    ...
    {
      name: 'MaraPlus Tierra Negra',
      slug: 'tierra-negra',
      address: 'Calle 72 con Av. 12, sector Tierra Negra',
      city: 'Maracaibo',
      state: 'Zulia',
      phone: '+58 261-555-0105',
      whatsapp: '+58 414-555-0105',
      openingHours: 'Lun–Sáb 8:00–22:00 · Dom 9:00–20:00',
      isMain: false,
      sortOrder: 5,
      latitude: 10.6666,
      longitude: -71.6055,
    ...
    {
      name: 'MaraPlus Dr. Portillo',
      slug: 'dr-portillo',
      address: 'Calle 78 (Dr. Portillo) con Av. 11',
      city: 'Maracaibo',
      state: 'Zulia',
    ...
    {
      name: 'MaraPlus Circunvalación N° 2',
      slug: 'circunvalacion-2',
    ...
    {
      name: 'MaraPlus La Coromoto',
      slug: 'la-coromoto',
      address: 'Av. 40, sector La Coromoto',
      city: 'San Francisco',
      state: 'Zulia',
      phone: '+58 261-555-0108',
      whatsapp: '+58 414-555-0108',
    ...
    {
      name: 'MaraPlus Ciudad Ojeda',
      slug: 'ciudad-ojeda',
      address: 'Av. Intercomunal con Calle Piar',
      city: 'Ciudad Ojeda',
      state: 'Zulia',
      phone: '+58 282-555-0109',
      whatsapp: '+58 414-555-0109',
    ...
    },
    {
      ...
      address: 'Av. Fuerzas Armadas, frente a Plaza de Toros',
      city: 'Maracaibo',
      state: 'Zulia',
      phone: '+58 261-555-0110',
      whatsapp: '+58 414-555-0110',
      openingHours: 'Lun–Dom 24 Horas',
      isMain: false,
      sortOrder: 10,
      latitude: 10.6705,
    ...
    {
      name: 'MaraPlus El Milagro',
      slug: 'el-milagro',
      address: 'Av. 2 El Milagro, CC Caribe Zulia',
      city: 'Maracaibo',
      state: 'Zulia',
      phone: '+58 261-555-0111',
    ...
    {
      name: 'MaraPlus Indio Mara',
      slug: 'indio-mara',
      address: 'Av. 22 con Calle 70, sector Indio Mara',
      city: 'Maracaibo',
      state: 'Zulia',
      phone: '+58 261-555-0112',
      whatsapp: '+58 414-555-0112',
      openingHours: 'Lun–Dom 24 Horas',
      isMain: false,
      sortOrder: 12,
      latitude: 10.6666,
