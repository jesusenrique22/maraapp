...
async function main() {
  ...
  const branchStockMatrix: Record<string, Record<string, number>> = {
    'FAR-001': {
      ...
      'sede-la-limpia': 34,
      'sede-delicias': 32,
      'sede-fuerzas-armadas': 30,
      'sede-ciudad-chinita': 40,
    },
    'FAR-002': {
      'sede-c2': 32,
      'sede-la-72': 28,
      ...
      'sede-la-limpia': 24,
      'sede-delicias': 22,
      'sede-fuerzas-armadas': 20,
      'sede-ciudad-chinita': 30,
    },
    'FAR-003': {
      'sede-c2': 24,
      'sede-la-72': 20,
      ...
      'sede-la-limpia': 16,
      'sede-delicias': 15,
      'sede-fuerzas-armadas': 14,
      'sede-ciudad-chinita': 22,
    },
    'PAN-001': {
      'sede-c2': 30,
      'sede-la-72': 22,
      ...
      'sede-la-limpia': 18,
      'sede-delicias': 16,
      'sede-fuerzas-armadas': 15,
      'sede-ciudad-chinita': 25,
    },
    'PAN-002': {
      'sede-c2': 40,
      'sede-la-72': 26,
      ...
      'sede-la-limpia': 22,
      'sede-delicias': 20,
      'sede-fuerzas-armadas': 18,
      'sede-ciudad-chinita': 28,
    },
    'PET-001': {
      'sede-c2': 10,
      'sede-la-72': 8,
      ...
      'sede-la-limpia': 7,
      'sede-delicias': 6,
      'sede-fuerzas-armadas': 6,
      'sede-ciudad-chinita': 9,
    },
    'ALI-001': {
      'sede-c2': 90,
      'sede-la-72': 70,
      ...
      'sede-la-limpia': 60,
      'sede-delicias': 55,
      'sede-fuerzas-armadas': 50,
      'sede-ciudad-chinita': 80,
    },
    'ALI-002': {
      'sede-c2': 28,
      'sede-la-72': 18,
  ...
  for (const item of allProducts) {
    if (!branchStockMatrix[item.sku]) {
      ...
      for (const slug of activeBranchSlugs) {
        stock[slug] = Math.floor(Math.random() * 35) + 15;
      }
      branchStockMatrix[item.sku] = stock;
    }
  }
